    ...
    <body>
     <header>
        ...
        <?php
        include 'db.inc.php';
        $sql = "SELECT * FROM appetizers UNION  SELECT * FROM bb UNION
        SELECT * FROM chinese UNION SELECT * FROM dessert UNION
        SELECT * FROM drinks UNION
        SELECT * FROM italian UNION 
        SELECT * FROM north UNION
        SELECT * FROM south";
