...
--
-- Host: localhost
-- Generation Time: Aug 25, 2021 at 10:16 PM
...
(406, 'Mango Falooda', 'mango', 25, '2 teaspoon sabja seeds, sweet basil seeds  - soaked in 3/4 cup water, 3 tablespoon falooda sev cooked as per package instructions,3 to 4 tablespoon rose syrup,1/2 to 2/3cup mango puree or two medium sized mangoes blended to a smooth puree in a blender,2 to 2.5 cups chilled milk,1 tablespoon chopped or sliced pistachios - or a mix of chopped dry fruits,3 to 4 scoops of mango ice cream or vanilla ice cream,1 medium sized mango, peeled and chopped in small cubes,crushed ice or ice cubes,mango custard,mango jelly,tutti frutti', 'First soak 2 tsp sabja seeds (sweet basil seeds) in 3/4 cup water for about 20 to 30 minutes.Later strain them with a tea strainer and keep aside.Then prepare the falooda sev according to package instructions.If you need to cook them then do boil them in water till they are cooked completely & softened.Rinse the cooked falooda sev in water and then drain them. Keep aside covered.allow them to cool completely at room temperature.In serving glasses, first add 1 tbsp rose syrup.Then add 2 tsp sabja seeds/sweet basil seeds.Next add 2 to 3 tsp falooda sev.Add 3 tbsp mango puree.Add 1/4 to 1/3 cup milk.Repeat the layers again.Add 1/3 to 1/2 cup milk.Add chopped mangoes.Top with a scoop of mango or vanilla ice cream and some chopped or sliced dry fruits. Also add some chopped mangoes.Serve mango falooda immediately.', 1, 4, 'https://tinyurl.com/zt7rjzy6');
